...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Track your fee payments and due amounts</p>
</div>
...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
    ...
    @else
        <div class="p-12 text-center">
            ...
            <p class="text-gray-500 dark:text-gray-400 mt-1">There are no fee records available for your account.</p>
        </div>
    @endif
</div>
@endsection
