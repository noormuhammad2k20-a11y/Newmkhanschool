...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Weekly class schedule</p>
</div>
...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden p-6">
    ...
    @else
        <div class="p-12 text-center">
            ...
            <p class="text-gray-500 dark:text-gray-400 mt-1">Your class timetable has not been published yet.</p>
        </div>
    @endif
</div>
@endsection
