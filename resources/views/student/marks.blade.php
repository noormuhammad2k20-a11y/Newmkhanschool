...
<div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Academic Performance</h1>
        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">View your marks and academic progress</p>
    </div>
</div>
...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
    ...
    @else
        <div class="p-12 text-center">
            ...
            <p class="text-gray-500 dark:text-gray-400 mt-1">Your academic marks will appear here once published.</p>
        </div>
    @endif
</div>
@endsection
