                    ...
                    @forelse($notes as $note)
                        <tr class="hover:bg-surface-container-low/50 transition-colors">
                            ...
                            <td class="p-md text-right">
                                ...
                                <form action="{{ route('admin.digital_notes.destroy', $note->id) }}" method="POST" class="inline" onsubmit="return confirm('Delete this note?');">
                                    @csrf @method('DELETE')
...
<div id="createNoteModal" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
    <div class="bg-surface-container-lowest rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form action="{{ route('admin.digital_notes.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-4">
            @csrf
            <div>
